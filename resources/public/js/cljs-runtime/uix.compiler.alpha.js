...
return cljs.core.some((function (p1__41765_SHARP_){
if(clojure.string.starts_with_QMARK_(p1__41765_SHARP_,"G_")){
return (component_type === uix.compiler.alpha.goog$module$goog$object.get(component_type,p1__41765_SHARP_));
} else {
return null;
}
...
if(cljs.core.truth_((function (){var and__5023__auto__ = cljs.core.not(component_type.uix_component_QMARK_);
...
var name_str_41821 = (function (){var or__5025__auto__ = component_type.displayName;
...
throw (new Error(["Invalid use of Reagent component ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(name_str_41821)," in `$` form.\n","UIx doesn't know how to render Reagent components.\n","Reagent element should be Hiccup wrapped with r/as-element, i.e. (r/as-element [",cljs.core.str.cljs$core$IFn$_invoke$arity$1(name_str_41821),"])"].join('')));
} else {
}
...
var and__5023__auto__ = cljs.core.not(x.hasOwnProperty("$$typeof"));
if(and__5023__auto__){
var G__41775 = x;
var G__41775__$1 = (((G__41775 == null))?null:G__41775.constructor);
if((G__41775__$1 == null)){
return null;
} else {
return (G__41775__$1 === Object);
}
} else {
return and__5023__auto__;
}
...
var and__5023__auto__ = ((typeof tag === 'string') || (cljs.core.not(tag.uix_component_QMARK_)));
if(and__5023__auto__){
var and__5023__auto____$1 = props;
...
var js_props = (function (){var temp__5827__auto__ = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(props);
if((temp__5827__auto__ == null)){
return ({"argv": props});
} else {
var key = temp__5827__auto__;
