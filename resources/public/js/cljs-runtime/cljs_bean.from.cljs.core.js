...
var G__41876 = cljs.core.next(xs);
var G__41877 = cljs.core.next(ys);
xs = G__41876;
ys = G__41877;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__41796 = val;
var G__41797 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__41796,G__41797) : f.call(null,G__41796,G__41797));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__41798 = val__$1;
var G__41799 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__41798,G__41799) : f.call(null,G__41798,G__41799));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__41810 = val__$1;
var G__41811 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__41810,G__41811) : f.call(null,G__41810,G__41811));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__41888 = cljs.core.next(es);
var G__41889 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__41888;
tcoll__$1 = G__41889;
continue;
} else {
...
var G__41890 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__41891 = cljs.core.next(es);
ret = G__41890;
es = G__41891;
continue;
} else {
