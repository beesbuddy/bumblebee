...
*/
devtools.toolbox.t_devtools$toolbox34542 = (function (obj,header,style,tag,meta34543){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
(devtools.toolbox.t_devtools$toolbox34542.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_34544,meta34543__$1){
var self__ = this;
var _34544__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox34542(self__.obj,self__.header,self__.style,self__.tag,meta34543__$1));
}));

(devtools.toolbox.t_devtools$toolbox34542.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_34544){
var self__ = this;
var _34544__$1 = this;
return self__.meta34543;
}));

(devtools.toolbox.t_devtools$toolbox34542.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL);

(devtools.toolbox.t_devtools$toolbox34542.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox34542.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
}));

(devtools.toolbox.t_devtools$toolbox34542.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox34542.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta34543","meta34543",978882012,null)], null);
}));

(devtools.toolbox.t_devtools$toolbox34542.cljs$lang$type = true);

(devtools.toolbox.t_devtools$toolbox34542.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox34542");

(devtools.toolbox.t_devtools$toolbox34542.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"devtools.toolbox/t_devtools$toolbox34542");
}));

/**
 * Positional factory function for devtools.toolbox/t_devtools$toolbox34542.
 */
devtools.toolbox.__GT_t_devtools$toolbox34542 = (function devtools$toolbox$__GT_t_devtools$toolbox34542(obj,header,style,tag,meta34543){
return (new devtools.toolbox.t_devtools$toolbox34542(obj,header,style,tag,meta34543));
});
...
return (new devtools.toolbox.t_devtools$toolbox34542(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
}));
