...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_35034 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_35034(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_35037 = (function (port,val,fn1_handler){
var x__5373__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_35037(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_35039 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_35039(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_35040 = (function (chan){
var x__5373__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_35040(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_35041 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_35041(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_35042 = (function (h){
var x__5373__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_35042(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_35043 = (function (h){
var x__5373__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_35043(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_35044 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_35044(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_35045 = (function (b){
var x__5373__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_35045(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_35047 = (function (b,itm){
var x__5373__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_35047(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_35052 = (function (b){
var x__5373__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_35052(b);
}
});
