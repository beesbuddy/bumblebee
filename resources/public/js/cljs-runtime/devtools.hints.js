...
var map__32309 = top_item;
var map__32309__$1 = cljs.core.__destructure_map(map__32309);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32309__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32309__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32309__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e32308){var _e = e32308;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5823__auto___32368 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5823__auto___32368)){
var seen_errors_32370 = temp__5823__auto___32368;
if(cljs.core.truth_(seen_errors_32370.has(self))){
} else {
seen_errors_32370.add(self);

var temp__5825__auto___32372 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5825__auto___32372)){
var sense_32373 = temp__5825__auto___32372;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_32373)].join(''));
} else {
}
}
} else {
