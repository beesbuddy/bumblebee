...
var i_37384 = (0);
while(true){
if((i_37384 < arr.length)){
(arr[i_37384] = null);

var G__37385 = (i_37384 + (1));
i_37384 = G__37385;
continue;
} else {
}
...
var i_37392 = (self__.level + (1));
while(true){
if((i_37392 <= (new_level + (1)))){
(update[i_37392] = self__.header);

var G__37394 = (i_37392 + (1));
i_37392 = G__37394;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_37395 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_37395[i]));
} else {
x__$2.forward.push((((i < links_37395.length))?(links_37395[i]):null));
}

if((i < links_37395.length)){
(links_37395[i] = x__$2);
} else {
links_37395.push(x__$2);
}
...
var i_37397 = (0);
while(true){
if((i_37397 <= self__.level)){
var links_37398 = (update[i_37397]).forward;
if((x__$1 === (((i_37397 < links_37398.length))?(links_37398[i_37397]):null))){
(links_37398[i_37397] = (x__$1.forward[i_37397]));

var G__37399 = (i_37397 + (1));
i_37397 = G__37399;
continue;
} else {
