...
while (G__44091__i < G__44091__a.length) {G__44091__a[G__44091__i] = arguments[G__44091__i + 0]; ++G__44091__i;}
  args = new cljs.core.IndexedSeq(G__44091__a,0,null);
} 
return G__44089__delegate.call(this,args);};
G__44089.cljs$lang$maxFixedArity = 0;
G__44089.cljs$lang$applyTo = (function (arglist__44095){
var args = cljs.core.seq(arglist__44095);
 ...
 */
uix.core.create_class = (function uix$core$create_class(p__43898){
var map__43899 = p__43898;
var map__43899__$1 = cljs.core.__destructure_map(map__43899);
var fields = map__43899__$1;
var contextType = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43899__$1,new cljs.core.Keyword(null,"contextType","contextType",1033066077));
var componentDidUpdate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43899__$1,new cljs.core.Keyword(null,"componentDidUpdate","componentDidUpdate",-1983477981));
var componentDidCatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43899__$1,new cljs.core.Keyword(null,"componentDidCatch","componentDidCatch",821717733));
var displayName = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43899__$1,new cljs.core.Keyword(null,"displayName","displayName",-809144601));
var childContextTypes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43899__$1,new cljs.core.Keyword(null,"childContextTypes","childContextTypes",578717991));
var getSnapshotBeforeUpdate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43899__$1,new cljs.core.Keyword(null,"getSnapshotBeforeUpdate","getSnapshotBeforeUpdate",861122184));
var contextTypes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43899__$1,new cljs.core.Keyword(null,"contextTypes","contextTypes",-2023853910));
var getDerivedStateFromProps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43899__$1,new cljs.core.Keyword(null,"getDerivedStateFromProps","getDerivedStateFromProps",-991834739));
var getDerivedStateFromError = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43899__$1,new cljs.core.Keyword(null,"getDerivedStateFromError","getDerivedStateFromError",166658477));
var componentWillUnmount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43899__$1,new cljs.core.Keyword(null,"componentWillUnmount","componentWillUnmount",1573788814));
var shouldComponentUpdate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43899__$1,new cljs.core.Keyword(null,"shouldComponentUpdate","shouldComponentUpdate",1795750960));
var render = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43899__$1,new cljs.core.Keyword(null,"render","render",-1408033454));
var defaultProps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43899__$1,new cljs.core.Keyword(null,"defaultProps","defaultProps",-533483149));
var getInitialState = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43899__$1,new cljs.core.Keyword(null,"getInitialState","getInitialState",1541760916));
var constructor$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43899__$1,new cljs.core.Keyword(null,"constructor","constructor",-1953928811));
var componentDidMount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43899__$1,new cljs.core.Keyword(null,"componentDidMount","componentDidMount",955710936));
...
var G__43909 = props.argv;
if(cljs.core.truth_(props.children)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43909,new cljs.core.Keyword(null,"children","children",-940561982),props.children);
} else {
return G__43909;
}
});
...
if((ref.current == null)){
(ref.current = (function (){var x43933 = ({"current": value});
(x43933.cljs$core$IDeref$ = cljs.core.PROTOCOL_SENTINEL);

(x43933.cljs$core$IDeref$_deref$arity$1 = (function (this$){
var this$__$1 = this;
return this$__$1.current;
}));

(x43933.cljs$core$IReset$ = cljs.core.PROTOCOL_SENTINEL);

(x43933.cljs$core$IReset$_reset_BANG_$arity$2 = (function (this$,v){
var this$__$1 = this;
return (this$__$1.current = v);
}));

(x43933.cljs$core$ISwap$ = cljs.core.PROTOCOL_SENTINEL);

(x43933.cljs$core$ISwap$_swap_BANG_$arity$2 = (function (this$,f){
var this$__$1 = this;
return (this$__$1.current = (function (){var G__43940 = this$__$1.current;
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__43940) : f.call(null,G__43940));
})());
}));

(x43933.cljs$core$ISwap$_swap_BANG_$arity$3 = (function (this$,f,a){
var this$__$1 = this;
return (this$__$1.current = (function (){var G__43946 = this$__$1.current;
var G__43947 = a;
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__43946,G__43947) : f.call(null,G__43946,G__43947));
})());
}));

(x43933.cljs$core$ISwap$_swap_BANG_$arity$4 = (function (this$,f,a,b){
var this$__$1 = this;
return (this$__$1.current = (function (){var G__43950 = this$__$1.current;
var G__43951 = a;
var G__43952 = b;
return (f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__43950,G__43951,G__43952) : f.call(null,G__43950,G__43951,G__43952));
})());
}));

(x43933.cljs$core$ISwap$_swap_BANG_$arity$5 = (function (this$,f,a,b,xs){
var this$__$1 = this;
...
var G__44011 = cljs_bean.core.bean.cljs$core$IFn$_invoke$arity$1(p1__44010_SHARP_);
 ...
 */
uix.core.create_error_boundary = (function uix$core$create_error_boundary(p__44028,render_fn){
var map__44030 = p__44028;
var map__44030__$1 = cljs.core.__destructure_map(map__44030);
var display_name = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__44030__$1,new cljs.core.Keyword(null,"display-name","display-name",694513143),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1("uix.error-boundary")));
var derive_error_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44030__$1,new cljs.core.Keyword(null,"derive-error-state","derive-error-state",-1373095498));
var did_catch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44030__$1,new cljs.core.Keyword(null,"did-catch","did-catch",2139522313));
...
var G__44032 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [state.argv,set_state], null);
var G__44033 = uix.core.glue_args(props);
return (render_fn.cljs$core$IFn$_invoke$arity$2 ? render_fn.cljs$core$IFn$_invoke$arity$2(G__44032,G__44033) : render_fn.call(null,G__44032,G__44033));
});
...
var argv = (function (){var G__44039 = props.argv;
var G__44039__$1 = (cljs.core.truth_(props.children)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44039,new cljs.core.Keyword(null,"children","children",-940561982),props.children):G__44039);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44039__$1,new cljs.core.Keyword(null,"ref","ref",1289896967),ref);
...
var update_children = (function (p1__44044_SHARP_){
if(cljs.core.truth_(p1__44044_SHARP_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (el){
if(cljs.core.truth_((function (){var G__44058 = el;
if((G__44058 == null)){
return null;
} else {
return G__44058._store;
}
})())){
...
var nel = uix.compiler.alpha.component_element(type,uix.compiler.attributes.interpret_props((function (){var G__44061 = props__$1;
if(cljs.core.seq(children__$1)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44061,new cljs.core.Keyword(null,"children","children",-940561982),cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(children__$1));
} else {
return G__44061;
}
})()),[]);
...
return uix.compiler.alpha.component_element(type,uix.compiler.attributes.interpret_props((function (){var G__44072 = oprops;
var G__44072__$1 = (cljs.core.truth_(okey)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44072,new cljs.core.Keyword(null,"key","key",-1516042587),okey):G__44072);
var G__44072__$2 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__44072__$1,props__$1], 0))
;
if(cljs.core.seq(children__$1)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44072__$2,new cljs.core.Keyword(null,"children","children",-940561982),children__$1);
} else {
return G__44072__$2;
}
})()),[]);
...
/** @this {Function} */
(uix.core.clone_element.cljs$lang$applyTo = (function (seq44049){
var G__44050 = cljs.core.first(seq44049);
var seq44049__$1 = cljs.core.next(seq44049);
var G__44051 = cljs.core.first(seq44049__$1);
var seq44049__$2 = cljs.core.next(seq44049__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44050,G__44051,seq44049__$2);
}));
