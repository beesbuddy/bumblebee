...
if(((clojure.string.starts_with_QMARK_(name_str,"aria-")) || (((clojure.string.starts_with_QMARK_(name_str,"data-")) || (clojure.string.starts_with_QMARK_(name_str,"--")))))){
return name_str;
} else {
...
var temp__5827__auto__ = (uix.compiler.attributes.prop_name_cache[name_str]);
...
if((k instanceof cljs.core.Keyword)){
var name_str = k.cljs$core$INamed$_name$arity$1(null);
var temp__5827__auto__ = (uix.compiler.attributes.custom_prop_name_cache[name_str]);
if((temp__5827__auto__ == null)){
var v = uix.compiler.attributes.dash_to_camel(name_str);
...
return (function() { 
var G__41743__delegate = function (rest__41598_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,rest__41598_SHARP_);
};
var G__41743 = function (var_args){
var rest__41598_SHARP_ = null;
...
while (G__41744__i < G__41744__a.length) {G__41744__a[G__41744__i] = arguments[G__41744__i + 0]; ++G__41744__i;}
  rest__41598_SHARP_ = new cljs.core.IndexedSeq(G__41744__a,0,null);
} 
return G__41743__delegate.call(this,rest__41598_SHARP_);};
G__41743.cljs$lang$maxFixedArity = 0;
G__41743.cljs$lang$applyTo = (function (arglist__41745){
var rest__41598_SHARP_ = cljs.core.seq(arglist__41745);
return G__41743__delegate(rest__41598_SHARP_);
});
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__41748__delegate = function (rest__41604_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,rest__41604_SHARP_);
};
var G__41748 = function (var_args){
var rest__41604_SHARP_ = null;
if (arguments.length > 0) {
...
while (G__41749__i < G__41749__a.length) {G__41749__a[G__41749__i] = arguments[G__41749__i + 0]; ++G__41749__i;}
  rest__41604_SHARP_ = new cljs.core.IndexedSeq(G__41749__a,0,null);
} 
return G__41748__delegate.call(this,rest__41604_SHARP_);};
G__41748.cljs$lang$maxFixedArity = 0;
G__41748.cljs$lang$applyTo = (function (arglist__41750){
var rest__41604_SHARP_ = cljs.core.seq(arglist__41750);
return G__41748__delegate(rest__41604_SHARP_);
});
...
var len__5749__auto___41760 = arguments.length;
var i__5750__auto___41761 = (0);
while(true){
if((i__5750__auto___41761 < len__5749__auto___41760)){
args_arr__5774__auto__.push((arguments[i__5750__auto___41761]));

var G__41762 = (i__5750__auto___41761 + (1));
i__5750__auto___41761 = G__41762;
continue;
} else {
}
break;
...
return uix.compiler.attributes.class_names.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5775__auto__);
...
/** @this {Function} */
(uix.compiler.attributes.class_names.cljs$lang$applyTo = (function (seq41641){
var G__41642 = cljs.core.first(seq41641);
var seq41641__$1 = cljs.core.next(seq41641);
var G__41643 = cljs.core.first(seq41641__$1);
var seq41641__$2 = cljs.core.next(seq41641__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41642,G__41643,seq41641__$2);
}));
...
if(cljs.core.truth_((function (){var and__5023__auto__ = cljs.core.not(cljs.core.re_matches(uix.compiler.attributes.re_tag,tag_str));
...
var vec__41686 = cljs.core.next(cljs.core.re_matches(uix.compiler.attributes.re_tag,tag_str));
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41686,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41686,(1),null);
var class_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41686,(2),null);
...
var G__41696 = props;
var G__41696__$1 = (((((!((id == null)))) && ((cljs.core.get.cljs$core$IFn$_invoke$arity$2(props,new cljs.core.Keyword(null,"id","id",-1388402092)) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41696,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__41696);
if(cljs.core.truth_((function (){var or__5025__auto__ = class$;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41696__$1,new cljs.core.Keyword(null,"class","class",-2030961996),uix.compiler.attributes.class_names.cljs$core$IFn$_invoke$arity$2(class$,props_class));
} else {
return G__41696__$1;
}
});
