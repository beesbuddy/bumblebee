...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41386 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41386(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41387 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41387(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41392 = (function (reader,ch){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41392(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41393 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41393(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41394 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41394(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41396 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41396(reader);
}
});
...
var G__41420 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__41421 = s.append(c);
c = G__41420;
s = G__41421;
continue;
}
