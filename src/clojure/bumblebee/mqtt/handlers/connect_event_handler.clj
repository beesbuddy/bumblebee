...
;; Expect :mqtt-store to be provided by dispatcher as a map including :session-store
;; This wrapper is kept for testing convenience; it can inject a provided store map.
